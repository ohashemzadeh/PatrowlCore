"""
Django settings for PatrowlCore project.
...
SECRET_KEY = 'django-insecure-874n&+(c(up1hccq&6930zx+dpp@32z-8klqg$kv4t_6qi%kg0'
...
WSGI_APPLICATION = 'PatrowlCore.wsgi.application'
